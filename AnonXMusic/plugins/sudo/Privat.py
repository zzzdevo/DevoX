...
from AnonXMusic.utils.database import (add_private_chat,
...
@app.on_message(filters.command("pri") & SUDOERS)
@language
...
@app.on_message(filters.command("unpri") & SUDOERS)
@language
...
@app.on_message(filters.command("prilist") & SUDOERS)
@language
